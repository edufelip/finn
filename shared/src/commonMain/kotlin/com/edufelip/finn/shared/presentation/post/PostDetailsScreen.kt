...
fun PostDetailsScreen(
    ...
    Column(
        ...
        Row(verticalAlignment = Alignment.CenterVertically, horizontalArrangement = Arrangement.spacedBy(12.dp)) {
            if (!currentPost.communityImage.isNullOrBlank()) {
                SharedImage(
                    url = currentPost.communityImage,
            ...
            Column(Modifier.weight(1f), verticalArrangement = Arrangement.spacedBy(4.dp)) {
                ...
                currentPost.dateMillis?.let {
                    Text(text = formatRelative(it), style = MaterialTheme.typography.bodySmall, color = MaterialTheme.colorScheme.onSurfaceVariant)
                }
            }
        ...
        if (!currentPost.image.isNullOrBlank()) {
            SharedImage(
