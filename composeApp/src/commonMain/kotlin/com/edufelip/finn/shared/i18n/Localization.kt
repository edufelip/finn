...
import finn.composeapp.generated.resources.*
...
data class StringsRes(
    ...
    val password: String,
    val forgot_your_password: String,
    val login: String,
    val e_mail: String,
    ...
    val send: String,
    val cached_label: String,
    val create_post: String,
    val create_post_description: String,
    val create_community: String,
    val create_community_description: String,
...
private fun stringsFromResources(): StringsRes = StringsRes(
    ...
    hide = stringResource(Res.string.hide),
    subscribe = stringResource(Res.string.subscribe),
    unsubscribe = stringResource(Res.string.unsubscribe),
    delete = stringResource(Res.string.delete),
    created_on = stringResource(Res.string.created_on),
    subscribers_count = stringResource(Res.string.subscribers_count),
    ...
    forgot_your_password = stringResource(Res.string.forgot_your_password),
    login = stringResource(Res.string.login),
    e_mail = stringResource(Res.string.e_mail),
    create_account = stringResource(Res.string.create_account),
    ...
    cached_label = stringResource(Res.string.cached_label),
    create_post = stringResource(Res.string.create_post),
    create_post_description = stringResource(Res.string.create_post_description),
    create_community = stringResource(Res.string.create_community),
    create_community_description = stringResource(Res.string.create_community_description),
    privacy_policy = stringResource(Res.string.privacy_policy),
...
val LocalStrings = staticCompositionLocalOf {
    ...
    StringsRes(
        ...
        share = "", more = "", hide = "", subscribe = "", unsubscribe = "", delete = "", created_on = "", subscribers_count = "",
        not_authenticated = "", content_empty = "", unknown_error = "",
        login_placeholder = "", continue_label = "",
        password = "", forgot_your_password = "", login = "", e_mail = "", create_account = "",
        comments_header = "", no_comments = "", reply = "", write_comment = "", send = "",
        cached_label = "", create_post = "", create_post_description = "", create_community = "", create_community_description = "", privacy_policy = "",
